...
\section{测试与验证}abel{exp}

\subsection{实验方法}abel{sub:ptxeva}
...
\subsection{实验结果}abel{sub:ptxeva}
...
\subsection{结果分析与讨论}abel{sub:analyze}
